            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN or gameStart == True:
                    ...
                    if self.startButton.checkForInput(mousePos):
                        ...
                        #tank 2, top middle
                        elif pygame.sprite.collide_rect(self.player, self.fishTank2):
                        ...
                        #tank 3, top right
                        elif pygame.sprite.collide_rect(self.player, self.fishTank3):
                        ...
                        #tank 4, bottom left
                        elif pygame.sprite.collide_rect(self.player, self.fishTank4):
                        ...
                        elif pygame.sprite.collide_rect(self.player, self.fishTank5):
                        ...
                        #tank 6, bottom right
                        elif pygame.sprite.collide_rect(self.player, self.fishTank6):
